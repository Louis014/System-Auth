...
<!-- Mirrored from themesbrand.com/velzon/html/saas/auth-success-msg-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Feb 2024 11:49:38 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Sucesso | System Auth</title>
                        ...
                        <div class="card mt-4" style="box-shadow: 2px 5px 15px rgba(0, 0, 0, 0.500);">
                            <div class="card-body p-4 text-center">
                                ...
                                <div class="mt-4 pt-2">
                                    ...
                                    <p class="text-muted mx-4">Siga as instruções enviadas para o seu email para continuar.</p>
                                    <div class="mt-4">
                                        <a href="../" class="btn btn-success w-100">Ir para o
                                            login</a>
                                    </div>
                                </div>
                            </div>
